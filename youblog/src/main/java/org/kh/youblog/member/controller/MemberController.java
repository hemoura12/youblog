...
public class MemberController {
	...
	@RequestMapping(value="readSelectBlogMember.do")
	@ResponseBody
	public JSONObject readSelectBlogMember(@RequestBody Member ob){
		
		
		JSONObject job = new JSONObject();
		Member mb = new Member();
		mb = memberService.readSelectBlogMember(ob);
		
		
		job.put("memberid", mb.getMemberid());
		job.put("membername", mb.getMembername());
		job.put("profilephoto", mb.getProfilephoto());
