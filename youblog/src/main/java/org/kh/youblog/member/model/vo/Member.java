...
public class Member implements java.io.Serializable{
	...
	public Member(String memberid, String memberpw, String membername, String memberphone, String memberemail,
			...
			String profilephoto, String banner, int readercount, String chanelopen, String subscribeshare,
	...
	public String getChanelopen() {
		return chanelopen;
	}

	public void setChanelopen(String chanelopen) {
		this.chanelopen = chanelopen;
	}
	...
	public String toString() {
		return "Member [memberid=" + memberid + ", memberpw=" + memberpw + ", membername=" + membername
				...
				+ readercount + ", chanelopen=" + chanelopen + ", subscribeshare=" + subscribeshare + ", formula="
