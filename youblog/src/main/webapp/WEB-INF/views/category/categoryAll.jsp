...
<!--4x4 배열 시작-->
    <div class="conBox">
        <div class = "ul-table">
            <div class="ul-row">
                <div class="category_nav"><a href="categoryall.do" style="text-decoration:none"><i class="active"></i>전체</a>
                    &nbsp;<!--<span class="glyphicon glyphicon-menu-right"></span>-->
                </div>
                <div class="category_nav2">
                    <a class="first_link" href="categoryLife.do" style="text-decoration:none">라이프</a>
                    <a class="first_link" href="categoryTravel.do" style="text-decoration:none">여행·맛집</a>
                    <a class="first_link" href="categoryCulture.do" style="text-decoration:none">문화·연예</a>
                    <a class="first_link" href="categoryIT.do" style="text-decoration:none">IT</a>
                    <a class="first_link" href="categorySport.do" style="text-decoration:none">스포츠</a>
                    <a class="first_link" href="categoryCurrent.do" style="text-decoration:none">시사</a>
                </div>
