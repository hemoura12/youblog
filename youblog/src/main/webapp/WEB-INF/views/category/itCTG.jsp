        ...
        <div class = "ul-table">
            <div class="ul-row">
                <div class="category_nav"><a href="categorySelect.do?views=categoryAll&cate2=all" >전체</a>
                    ...
                    <a class="second_ctg" href="categorySelect.do?views=itCTG&cate2=all" >IT</a>
                </div>
                
                <div class="category_nav2">
                    <a class="first_link active" href="categorySelect.do?views=itCTG&cate2=all">전체</a>
                    <a class="first_link" href="categorySelect.do?views=itCTG&cate2=IT 인터넷">IT 인터넷</a>
                    <a class="first_link" href="categorySelect.do?views=itCTG&cate2=모바일">모바일</a>
                    <a class="first_link" href="categorySelect.do?views=itCTG&cate2=게임">게임</a>
                    <a class="first_link" href="categorySelect.do?views=itCTG&cate2=과학">과학</a>
                    <a class="first_link" href="categorySelect.do?views=itCTG&cate2=IT 제품리뷰" >IT 제품리뷰</a>
                </div>
